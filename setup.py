...
setup(
  ...
  url='http://gcudm.readthedocs.io/en/latest/index.html',  # Use the URL to the github repo.
  download_url='https://github.com/patdaburu/gcudm/archive/{version}.tar.gz'.format(version=version),
  keywords=[
